...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function getInternet(offer) {
        ...
        if (internetElement) {
            ...
            if (internetText.includes("Unlimited")) {
                return Infinity; 
            }
        }
        return 0; 
    ...
    function getMinutesInside(offer) {
        ...
        if (minutesElement) {
            ...
            if (minutesText.includes("Unlimited")) {
                return Infinity; 
            }
        }
        return 0; 
    ...
    function sortServices() {
        ...
        if (selectedService === "all") {
            ...
            } else if (sortButton.value.includes("By internet")) {
            ...
            } else if (sortButton.value.includes("By minutes within the network")) {
            ...
            } else if (sortButton.value.includes("By minutes to other networks")) {
